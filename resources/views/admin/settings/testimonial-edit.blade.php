...
<div class="content-wrapper">
	...
	<section class="content">
		<form class="" role="form" method="post" action="/admin/testimonial/edit-item" enctype="multipart/form-data">
			{{csrf_field()}}
			...
			<div class="col-md-12">
				...
				<textarea id="desc" cols="30" rows="4" class="form-control" name="content">{{$testimonial->content}}</textarea>
			</div>
